/*
 ...
 Created: Fri, 28 Aug 2020 17:08:19 Singapore Standard Time, Kuala Lumpur, Malaysia
...
const StatsSharedBorders = (props) => {
            ...
            <div className="mt-5 grid grid-cols-1 rounded-lg bg-white overflow-hidden shadow md:grid-cols-3">
                ...
                from 70,946
                                ...
                                <div
                                    ...
                                    <svg className="-ml-1 mr-0.5 flex-shrink-0 self-center h-5 w-5 text-green-500"
                ...
                from 28.62
                                ...
                                <div
                                    className="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium leading-5 bg-red-100 text-red-800 md:mt-2 lg:mt-0">
...
export default StatsSharedBorders;