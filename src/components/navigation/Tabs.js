...
const Option = (props) => {
    ...
    return (<I18n>
            {({i18n}) => (<option>{i18n._(t`${Object.values(props)[0].label}`)}</option>)}
        </I18n>)
}
...
const Tab = (props) => {
    ...
    return (<I18n>
            {({i18n}) => (<button onClick={() => props.changeTab(key)}
...
const Tabs = (props) => {
    ...
    return (<div>
                ...
                <div>
                    ...
                    <div className="hidden sm:block">
                        <nav className="-mb-px flex space-x-8">
                            ...
                            {props.tabs.map((tab) => (<Tab currentTab={currentTab} changeTab={changeTab} tab={tab}/>))}
        ...
        {props.tabs[props.tabs.findIndex(obj => Object.keys(obj)[0] === currentTab)][currentTab].content }
